"""
URL configuration for cristianapp project.
...
from vistas.views import ListarLibros,DetalleLibro,ActualizacionesLibros,CrearLibro,EliminarLibro 
...
urlpatterns = [
    ...
    path('editar/<int:pk>', ActualizacionesLibros.as_view(template_name = "actualizar.html"),name='actualizar'),
